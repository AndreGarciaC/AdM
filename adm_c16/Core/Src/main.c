...
#include <stdint.h>
#define N_FLTR 3
//seleccionar ejercicio a probar
#define macro1
...
#endif
#ifdef  macro6
	int16_t vectorIn[10] = {1,2,93512,4,5,68625,7,8,9,0};
	int16_t vectorOut[10];
	asm_pack32to16(vectorIn, vectorOut, 10);
#endif
#ifdef  macro7
...
#endif
#ifdef  macro8
	int32_t vectorIn[7] = {1,2,3,4,5,6,7};
	int32_t vectorOut[7];
	asm_downsampleM(vectorIn, vectorOut, 7, 2);
#endif
#ifdef  macro9
